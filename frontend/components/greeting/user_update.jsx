...
class UserUpdate extends React.Component {
  ...
  handleRemove() {
    this.setState({image_url: "http://s3.amazonaws.com/dismikechan-app-name-dev/users/images/000/000/001/original/discord-user-icon-1.png?1530400049", imageFile: null, type: true});
  }
